...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["vim-kitty"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/vim-kitty",
    url = "https://github.com/fladson/vim-kitty"
  },
  ["vim-wakatime"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/vim-wakatime",
